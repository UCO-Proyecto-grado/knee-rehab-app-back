...
from entidades_primarias.app.services import departamento_service
from entidades_primarias.app.schemas.departamento_schema import DepartamentoCreate, DepartamentoOut

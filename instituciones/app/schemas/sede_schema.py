...
from instituciones.app.schemas.centro_rehabilitacion_schema import CentroRehabilitacionOut
from instituciones.app.schemas.tipo_sede_schema import TipoSedeOut

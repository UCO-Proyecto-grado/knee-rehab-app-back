...
from lambda_entidades_primarias.services import pais_service
from lambda_entidades_primarias.schemas.pais_schema import PaisCreate, PaisUpdate, PaisOut

...
from lambda_instituciones.schemas.centro_rehabilitacion_schema import (
    CentroRehabilitacionCreate,
    CentroRehabilitacionUpdate,
    CentroRehabilitacionOut,
)
from lambda_instituciones.services import centro_rehabilitacion_service as service

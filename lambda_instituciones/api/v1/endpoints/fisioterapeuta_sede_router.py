...
from lambda_instituciones.schemas.fisioterapeuta_sede_schema import FisioterapeutaSedeCreate, FisioterapeutaSedeOut
from lambda_instituciones.services import fisioterapeuta_sede_service as service

...
from lambda_instituciones.services import tipo_sede_service
from lambda_instituciones.schemas.tipo_sede_schema import TipoSedeCreate, TipoSedeOut, TipoSedeUpdate

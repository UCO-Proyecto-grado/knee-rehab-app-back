...
from lambda_instituciones.api.v1.endpoints.sede_router import router as sede_router
from lambda_instituciones.api.v1.endpoints.fisioterapeuta_sede_router import router as fisioterapeuta_sede_router
...
router.include_router(sede_router, prefix="/sede")
router.include_router(fisioterapeuta_sede_router, prefix="/fisioterapeuta-sede")
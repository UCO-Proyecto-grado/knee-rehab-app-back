...
from lambda_instituciones.schemas.centro_rehabilitacion_schema import CentroRehabilitacionOut
from lambda_instituciones.schemas.tipo_sede_schema import TipoSedeOut

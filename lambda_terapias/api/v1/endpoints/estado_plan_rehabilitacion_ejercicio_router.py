...
from lambda_terapias.schemas.estado_plan_rehabilitacion_ejercicio_schema import (
    EstadoPRECreate, EstadoPREUpdate, EstadoPREOut
)
from lambda_terapias.services import estado_plan_rehabilitacion_ejercicio_service as service

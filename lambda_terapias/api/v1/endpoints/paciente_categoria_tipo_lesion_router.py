...
from lambda_terapias.schemas.paciente_categoria_tipo_lesion_schema import (
    PacienteCategoriaTipoLesionCreate,
    PacienteCategoriaTipoLesionOut
)
from lambda_terapias.services import paciente_categoria_tipo_lesion_service as service
...
router = APIRouter(prefix="/paciente-categoria-tipo-lesion", tags=["PacienteCategoriaTipoLesion"])

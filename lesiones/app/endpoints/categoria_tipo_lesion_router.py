...
from lesiones.app.schemas.categoria_tipo_lesion_schema import (
    CategoriaTipoLesionCreate, CategoriaTipoLesionOut
)
from lesiones.app.services import categoria_tipo_lesion_service as service
from lesiones.app.shared.utils.constants import HTTP_200_OK, HTTP_201_CREATED, HTTP_404_NOT_FOUND, HTTP_500_INTERNAL_SERVER_ERROR
from uuid import UUID

router = APIRouter(prefix="/categoria-tipo-lesion")

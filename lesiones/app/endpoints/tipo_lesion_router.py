...
from lesiones.app.schemas.tipo_lesion_schema import TipoLesionCreate, TipoLesionOut
from lesiones.app.services import tipo_lesion_service
from lesiones.app.shared.db.dependencies import get_db
from lesiones.app.shared.core.response_handler import success_response, error_response
from lesiones.app.shared.utils.constants import HTTP_200_OK, HTTP_201_CREATED, HTTP_400_BAD_REQUEST, HTTP_404_NOT_FOUND, HTTP_500_INTERNAL_SERVER_ERROR

router = APIRouter(prefix="/tipo-lesion")

...
from lesiones.app.models.categoria_tipo_lesion_model import CategoriaTipoLesion
from lesiones.app.schemas.categoria_tipo_lesion_schema import CategoriaTipoLesionCreate

...
from recursos_terapeuticos.app.services.ejercicio_service import get_ejercicio, get_ejercicio_by_id, create_ejercicio, update_ejercicio, delete_ejercicio, get_ejercicio_por_centro_rehabilitacion
...
router = APIRouter(prefix="/ejercicios")
